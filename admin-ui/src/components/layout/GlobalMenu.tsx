...
// Plan gating aligné sur MODULE_TO_PLAN (Sidebar.tsx) — modèle 27 avril 2026
// Free: reservations, ecommerce | Starter: IA, CRM | Pro: facturation, devis, pipeline, stock, marketing, equipe, planning, fidelite
// Business: compta, SEO, API | Enterprise: analytics, RH, sentinel, white-label, SSO
const menuItems = [
  { icon: Home, label: 'Home', path: '/' },
  { type: 'separator', label: 'Principal' },
  { icon: Calendar, label: 'Agenda', path: '/agenda' },
  { icon: CalendarCheck, label: 'Prestations', path: '/activites', hideFor: ['commerce'] },
  { icon: CalendarDays, label: 'Planning', path: '/planning', plan: 'pro' },
  ...
  { icon: UserPlus, label: 'Equipe', path: '/equipe', plan: 'pro' },
  { icon: Clock, label: 'Disponibilités', path: '/disponibilites' },
  { icon: Star, label: 'Fidélité', path: '/fidelite', plan: 'pro' },
  ...
  { icon: CreditCard, label: 'Facturation', path: '/facturation', plan: 'pro' },
  { icon: BarChart3, label: 'Analytics', path: '/analytics', plan: 'enterprise' },
  { icon: FileText, label: 'Comptabilité', path: '/comptabilite', plan: 'business' },
  { icon: Package, label: 'Stock', path: '/stock', plan: 'pro' },
  { icon: UserCog, label: 'Équipe RH', path: '/rh', plan: 'enterprise' },
  ...
  { icon: Megaphone, label: 'Pipeline', path: '/pipeline', plan: 'pro', hideFor: ['salon', 'restaurant', 'hotel', 'commerce'] },
  { icon: FileText, label: 'Devis', path: '/devis', plan: 'pro', hideFor: ['salon', 'restaurant', 'hotel', 'commerce'] },
  { icon: Search, label: 'SEO', path: '/seo', plan: 'business' },
  { icon: FileText, label: 'Articles SEO', path: '/seo/articles', plan: 'business' },
  { icon: AlertTriangle, label: 'Anti-Churn', path: '/churn', plan: 'pro' },
  { icon: Share2, label: 'Réseaux Sociaux', path: '/reseaux-sociaux', plan: 'pro' },
  { icon: UserCheck, label: 'Onboarding', path: '/onboarding-sequences', plan: 'pro' },
  ...
  { icon: Shield, label: 'Sentinel', path: '/sentinel', plan: 'enterprise' },
  { type: 'separator' },
