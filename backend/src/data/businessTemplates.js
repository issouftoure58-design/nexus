...
export const NEXUS_PLANS = {
  essential: {
    ...
    includes: [
      'Dashboard & Analytics',
      'Gestion clients',
      '1 canal IA au choix (Web, WhatsApp ou Téléphone)',
      '100 interactions IA/mois',
      'Support email',
    ],
    modules: ['base'],
    maxIaModules: 1,
  ...
  enterprise: {
    ...
    modules: ['base', 'reservations', 'rh_avance', 'comptabilite', 'analytics'],
