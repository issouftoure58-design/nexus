...
export async function generateFollowUpEmail(prospect, emailType, previousSubject) {
  ...
  const angles = {
    ...
    followup_j14: 'Angle: dernier message, ton sincere. Proposer le plan Free gratuit a vie (sans carte bancaire, 10 RDV/mois). Pas d\'agressivite, juste de la franchise. Court (60 mots max).',
  };
