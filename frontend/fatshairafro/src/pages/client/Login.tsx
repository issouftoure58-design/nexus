        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/20 backdrop-blur-sm rounded-full border border-amber-500/30 mb-6">
              ...
              <span className="text-amber-300 text-sm font-medium">Espace Client</span>
            </div>
            ...
            <p className="text-white/60">
              Accédez à votre espace fidélité et vos rendez-vous
            </p>
          </div>
          ...
          <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 overflow-hidden">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus:border-amber-500/50 focus:ring-amber-500/20"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="text-center">
              ...
              <Link href="/mon-compte/inscription">
                <Button
                  variant="outline"
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["Carte fidélité", "Historique RDV", "Points cadeaux"].map(
                (benefit) => (
                  <span
                    key={benefit}
